import{_ as n,o as a,c as s,e}from"./app-shgjB76R.js";const i={},l=e(`<h1 id="docker-使用" tabindex="-1"><a class="header-anchor" href="#docker-使用"><span>Docker 使用</span></a></h1><h2 id="docker环境安装" tabindex="-1"><a class="header-anchor" href="#docker环境安装"><span>Docker环境安装</span></a></h2><h3 id="docker安装" tabindex="-1"><a class="header-anchor" href="#docker安装"><span>Docker安装</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># CenterOS 安装</span>
