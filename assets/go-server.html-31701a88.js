import{_ as n,O as s,P as a,a5 as e}from"./framework-27923892.js";const t={},i=e(`<h1 id="使用go打包代理前端代码" tabindex="-1"><a class="header-anchor" href="#使用go打包代理前端代码" aria-hidden="true">#</a> 使用Go打包代理前端代码</h1><h2 id="背景" tabindex="-1"><a class="header-anchor" href="#背景" aria-hidden="true">#</a> 背景</h2><p>近日有一前端项目需要写部署文档有甲方内网离线部署。考虑到nginx安装、配置复杂容易出错。遂想到之前使用GO可直接生成运行文件、简化部署流程。</p><h2 id="生成运行文件" tabindex="-1"><a class="header-anchor" href="#生成运行文件" aria-hidden="true">#</a> 生成运行文件</h2><h3 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token comment"># 进入文件</span>
 ./main
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="部署前端项目" tabindex="-1"><a class="header-anchor" href="#部署前端项目" aria-hidden="true">#</a> 部署前端项目</h2><p>将前端项目放至同层static目录下即可</p>`,13),p=[i];function o(c,l){return s(),a("div",null,p)}const r=n(t,[["render",o],["__file","go-server.html.vue"]]);export{r as default};
