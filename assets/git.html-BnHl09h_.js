import{_ as n,c as s,o as a,a as e}from"./app-DaJ1Kvbf.js";const i={},t=e(`<h1 id="git-使用" tabindex="-1"><a class="header-anchor" href="#git-使用"><span>Git 使用</span></a></h1><h2 id="相关博客" tabindex="-1"><a class="header-anchor" href="#相关博客"><span>相关博客</span></a></h2><p><a href="http://www.ruanyifeng.com/blog/2012/07/git.html" target="_blank" rel="noopener noreferrer">Git 分支管理策略</a></p><p><a href="http://www.ruanyifeng.com/blog/2014/06/git_remote.html" target="_blank" rel="noopener noreferrer">Git 远程操作详解</a></p><p><a href="http://www.ruanyifeng.com/blog/2015/08/git-use-process.html" target="_blank" rel="noopener noreferrer">Git 使用规范流程</a></p><p><a href="https://www.jianshu.com/p/420d38913578" target="_blank" rel="noopener noreferrer">Git 解决远程仓库文件大小写问题</a></p><h2 id="基础使用" tabindex="-1"><a class="header-anchor" href="#基础使用"><span>基础使用</span></a></h2><ul><li>基础推送操作</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 把文件添加到暂存区</span>
