import{_ as e,o as n,c as a,e as i}from"./app-dda5edae.js";const s={},r=i(`<h1 id="debian常用命令" tabindex="-1"><a class="header-anchor" href="#debian常用命令" aria-hidden="true">#</a> debian常用命令</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看debian版本</span>
