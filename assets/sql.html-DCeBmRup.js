import{_ as s,o as a,c as n,e}from"./app-shgjB76R.js";const l={},t=e(`<h1 id="sql使用" tabindex="-1"><a class="header-anchor" href="#sql使用"><span>SQL使用</span></a></h1><h2 id="导出mysql数据库中的表结构" tabindex="-1"><a class="header-anchor" href="#导出mysql数据库中的表结构"><span>导出MySQL数据库中的表结构</span></a></h2><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
