import{_ as l,P as i,Q as r,S as s,a4 as e,a5 as n,a6 as t,E as o}from"./framework-ddfe6bc1.js";const c={},d=s("h1",{id:"wsl开发",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#wsl开发","aria-hidden":"true"},"#"),e(" WSL开发")],-1),p=s("h2",{id:"相关博客",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#相关博客","aria-hidden":"true"},"#"),e(" 相关博客")],-1),u={href:"https://zhuanlan.zhihu.com/p/122214146",target:"_blank",rel:"noopener noreferrer"},m={href:"https://learn.microsoft.com/zh-cn/windows/wsl/basic-commands",target:"_blank",rel:"noopener noreferrer"},v=t(`<h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 列出可用的 Linux 发行版</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol>`,4);function b(h,k){const a=o("ExternalLinkIcon");return i(),r("div",null,[d,p,s("ol",null,[s("li",null,[s("a",u,[e("Linux系统各发行版换国内yum或apt源，加速软件下载更新"),n(a)])])]),s("blockquote",null,[s("p",null,[s("a",m,[e("微软官方文档"),n(a)])])]),v])}const g=l(c,[["render",b],["__file","wsl.html.vue"]]);export{g as default};
