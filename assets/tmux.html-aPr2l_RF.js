import{_ as n,o as s,c as a,e}from"./app-NDKZubBW.js";const i={},l=e(`<h1 id="终端复用器" tabindex="-1"><a class="header-anchor" href="#终端复用器" aria-hidden="true">#</a> 终端复用器</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Debian/Ubuntu</span>
