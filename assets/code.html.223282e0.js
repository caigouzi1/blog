import{_ as n,a as s}from"./app.e62bbe89.js";const a={},e=s(`<h1 id="\u524D\u7AEF\u5E38\u7528\u4EE3\u7801\u5757" tabindex="-1"><a class="header-anchor" href="#\u524D\u7AEF\u5E38\u7528\u4EE3\u7801\u5757" aria-hidden="true">#</a> \u524D\u7AEF\u5E38\u7528\u4EE3\u7801\u5757</h1><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>const currency = (money, needDecimal = true) =&gt; {
  // \u683C\u5F0F\u5316\u8D27\u5E01\u663E\u793A
  if (isNaN(money)) {
    return 0;
  }
