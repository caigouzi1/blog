...
`,j=function(e,t){return u(e,t)},M=function(e,t){let n=e.append(`circle`).attr(`cx`,t.cx).attr(`cy`,t.cy).attr(`class`,`face`).attr(`r`,15).attr(`stroke-width`,2).attr(`overflow`,`visible`),r=e.append(`g`);r.append(`circle`).attr(`cx`,t.cx-15/3).attr(`cy`,t.cy-15/3).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`),r.append(`circle`).attr(`cx`,t.cx+15/3).attr(`cy`,t.cy-15/3).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`);function i(e){let n=m().startAngle(Math.PI/2).endAngle(Math.PI/2*3).innerRadius(7.5).outerRadius(6.8181818181818175);e.append(`path`).attr(`class`,`mouth`).attr(`d`,n).attr(`transform`,`translate(`+t.cx+`,`+(t.cy+2)+`)`)}function a(e){let n=m().startAngle(3*Math.PI/2).endAngle(Math.PI/2*5).innerRadius(7.5).outerRadius(6.8181818181818175);e.append(`path`).attr(`class`,`mouth`).attr(`d`,n).attr(`transform`,`translate(`+t.cx+`,`+(t.cy+7)+`)`)}function o(e){e.append(`line`).attr(`class`,`mouth`).attr(`stroke`,2).attr(`x1`,t.cx-5).attr(`y1`,t.cy+7).attr(`x2`,t.cx+5).attr(`y2`,t.cy+7).attr(`class`,`mouth`).attr(`stroke-width`,`1px`).attr(`stroke`,`#666`)}return t.score>3?i(r):t.score<3?a(r):o(r),n},N=function(e,t){let n=e.append(`circle`);return n.attr(`cx`,t.cx),n.attr(`cy`,t.cy),n.attr(`class`,`actor-`+t.pos),n.attr(`fill`,t.fill),n.attr(`stroke`,t.stroke),n.attr(`r`,t.r),n.class!==void 0&&n.attr(`class`,n.class),t.title!==void 0&&n.append(`title`).text(t.title),n},P=function(e,t){return p(e,t)},F=function(e,t){function n(e,t,n,r,i){return e+`,`+t+` `+(e+n)+`,`+t+` `+(e+n)+`,`+(t+r-i)+` `+(e+n-i*1.2)+`,`+(t+r)+` `+e+`,`+(t+r)}let r=e.append(`polygon`);r.attr(`points`,n(t.x,t.y,50,20,7)),r.attr(`class`,`labelBox`),t.y+=t.labelMargin,t.x+=.5*t.labelMargin,P(e,t)},I=function(e,t,n){let r=e.append(`g`),i=d();i.x=t.x,i.y=t.y,i.fill=t.fill,i.width=n.width*t.taskCount+n.diagramMarginX*(t.taskCount-1),i.height=n.height,i.class=`journey-section section-type-`+t.num,i.rx=3,i.ry=3,j(r,i),B(n)(t.text,r,i.x,i.y,i.width,i.height,{class:`journey-section section-type-`+t.num},n,t.colour)},L=-1,R=function(e,t,n){let r=t.x+n.width/2,i=e.append(`g`);L++,i.append(`line`).attr(`id`,`task`+L).attr(`x1`,r).attr(`y1`,t.y).attr(`x2`,r).attr(`y2`,450).attr(`class`,`task-line`).attr(`stroke-width`,`1px`).attr(`stroke-dasharray`,`4 2`).attr(`stroke`,`#666`),M(i,{cx:r,cy:300+(5-t.score)*30,score:t.score});let a=d();a.x=t.x,a.y=t.y,a.fill=t.fill,a.width=n.width,a.height=n.height,a.class=`task task-type-`+t.num,a.rx=3,a.ry=3,j(i,a);let o=t.x+14;t.people.forEach(e=>{let n=t.actors[e].color,r={cx:o,cy:t.y,r:7,fill:n,stroke:`#000`,title:e,pos:t.actors[e].position};N(i,r),o+=10}),B(n)(t.task,i,a.x,a.y,a.width,a.height,{class:`task`},n,t.colour)},z=function(e,t){f(e,t)},B=function(){function e(e,t,n,i,a,o,s,c){r(t.append(`text`).attr(`x`,n+a/2).attr(`y`,i+o/2+5).style(`font-color`,c).style(`text-anchor`,`middle`).text(e),s)}function t(e,t,n,i,a,o,s,c,l){let{taskFontSize:u,taskFontFamily:d}=c,f=e.split(/<br\s*\/?>/gi);for(let e=0;e<f.length;e++){let c=e*u-u*(f.length-1)/2,p=t.append(`text`).attr(`x`,n+a/2).attr(`y`,i).attr(`fill`,l).style(`text-anchor`,`middle`).style(`font-size`,u).style(`font-family`,d);p.append(`tspan`).attr(`x`,n+a/2).attr(`dy`,c).text(f[e]),p.attr(`y`,i+o/2).attr(`dominant-baseline`,`central`).attr(`alignment-baseline`,`central`),r(p,s)}}function n(e,n,i,a,o,s,c,l){let u=n.append(`switch`),d=u.append(`foreignObject`).attr(`x`,i).attr(`y`,a).attr(`width`,o).attr(`height`,s).attr(`position`,`fixed`).append(`xhtml:div`).style(`display`,`table`).style(`height`,`100%`).style(`width`,`100%`);d.append(`div`).attr(`class`,`label`).style(`display`,`table-cell`).style(`text-align`,`center`).style(`vertical-align`,`middle`).text(e),t(e,u,i,a,o,s,c,l),r(d,c)}function r(e,t){for(let n in t)n in t&&e.attr(n,t[n])}return function(r){return r.textPlacement===`fo`?n:r.textPlacement===`old`?e:t}}(),V={drawRect:j,drawCircle:N,drawSection:I,drawText:P,drawLabel:F,drawTask:R,drawBackgroundRect:z,initGraphics:function(e){e.append(`defs`).append(`marker`).attr(`id`,`arrowhead`).attr(`refX`,5).attr(`refY`,2).attr(`markerWidth`,6).attr(`markerHeight`,4).attr(`orient`,`auto`).append(`path`).attr(`d`,`M 0,0 V 4 L6,2 Z`)}},H=function(e){Object.keys(e).forEach(function(t){G[t]=e[t]})},U={};function W(e){let t=l().journey,n=60;Object.keys(U).forEach(r=>{let i=U[r].color,a={cx:20,cy:n,r:7,fill:i,stroke:`#000`,pos:U[r].position};V.drawCircle(e,a);let o={x:40,y:n+7,fill:`#666`,text:r,textMargin:t.boxTextMargin|5};V.drawText(e,o),n+=20})}var G=l().journey,K=G.leftMargin,q=function(e,t,i,a){let o=l().journey,s=l().securityLevel,c;s===`sandbox`&&(c=n(`#i`+t));let u=n(s===`sandbox`?c.nodes()[0].contentDocument.body:`body`);J.init();let d=u.select(`#`+t);V.initGraphics(d);let f=a.db.getTasks(),p=a.db.getDiagramTitle(),m=a.db.getActors();for(let e in U)delete U[e];let h=0;m.forEach(e=>{U[e]={color:o.actorColours[h%o.actorColours.length],position:h},h++}),W(d),J.insert(0,0,K,Object.keys(U).length*50),Z(d,f,0);let g=J.getBounds();p&&d.append(`text`).text(p).attr(`x`,K).attr(`font-size`,`4ex`).attr(`font-weight`,`bold`).attr(`y`,25);let _=g.stopy-g.starty+2*o.diagramMarginY,v=K+g.stopx+2*o.diagramMarginX;r(d,_,v,o.useMaxWidth),d.append(`line`).attr(`x1`,K).attr(`y1`,o.height*4).attr(`x2`,v-K-4).attr(`y2`,o.height*4).attr(`stroke-width`,4).attr(`stroke`,`black`).attr(`marker-end`,`url(#arrowhead)`);let y=p?70:0;d.attr(`viewBox`,`${g.startx} -25 ${v} ${_+y}`),d.attr(`preserveAspectRatio`,`xMinYMin meet`),d.attr(`height`,_+y+25)},J={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(e,t,n,r){e[t]===void 0?e[t]=n:e[t]=r(n,e[t])},updateBounds:function(e,t,n,r){let i=l().journey,a=this,o=0;function s(s){return function(c){o++;let l=a.sequenceItems.length-o+1;a.updateVal(c,`starty`,t-l*i.boxMargin,Math.min),a.updateVal(c,`stopy`,r+l*i.boxMargin,Math.max),a.updateVal(J.data,`startx`,e-l*i.boxMargin,Math.min),a.updateVal(J.data,`stopx`,n+l*i.boxMargin,Math.max),s!==`activation`&&(a.updateVal(c,`startx`,e-l*i.boxMargin,Math.min),a.updateVal(c,`stopx`,n+l*i.boxMargin,Math.max),a.updateVal(J.data,`starty`,t-l*i.boxMargin,Math.min),a.updateVal(J.data,`stopy`,r+l*i.boxMargin,Math.max))}}this.sequenceItems.forEach(s())},insert:function(e,t,n,r){let i=Math.min(e,n),a=Math.max(e,n),o=Math.min(t,r),s=Math.max(t,r);this.updateVal(J.data,`startx`,i,Math.min),this.updateVal(J.data,`starty`,o,Math.min),this.updateVal(J.data,`stopx`,a,Math.max),this.updateVal(J.data,`stopy`,s,Math.max),this.updateBounds(i,o,a,s)},bumpVerticalPos:function(e){this.verticalPos+=e,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},Y=G.sectionFills,X=G.sectionColours,Z=function(e,t,n){let r=l().journey,i=``,a=n+(r.height*2+r.diagramMarginY),o=0,s=`#CCC`,c=`black`,u=0;for(let[n,l]of t.entries()){if(i!==l.section){s=Y[o%Y.length],u=o%Y.length,c=X[o%X.length];let a=0,d=l.section;for(let e=n;e<t.length&&t[e].section==d;e++)a+=1;let f={x:n*r.taskMargin+n*r.width+K,y:50,text:l.section,fill:s,num:u,colour:c,taskCount:a};V.drawSection(e,f,r),i=l.section,o++}let d=l.people.reduce((e,t)=>(U[t]&&(e[t]=U[t]),e),{});l.x=n*r.taskMargin+n*r.width+K,l.y=a,l.width=r.diagramMarginX,l.height=r.diagramMarginY,l.colour=c,l.fill=s,l.num=u,l.actors=d,V.drawTask(e,l,r),J.insert(l.x,l.y,l.x+l.width+r.taskMargin,450)}},Q={setConf:H,draw:q},$={parser:g,db:k,renderer:Q,styles:A,init:e=>{Q.setConf(e.journey),k.clear()}};export{$ as diagram};