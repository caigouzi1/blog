import{_ as s,o as n,c as a,e}from"./app-0_PivuKa.js";const l={},i=e(`<h1 id="sql使用" tabindex="-1"><a class="header-anchor" href="#sql使用" aria-hidden="true">#</a> SQL使用</h1><h2 id="导出mysql数据库中的表结构" tabindex="-1"><a class="header-anchor" href="#导出mysql数据库中的表结构" aria-hidden="true">#</a> 导出MySQL数据库中的表结构</h2><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
