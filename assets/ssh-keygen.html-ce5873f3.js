import{_ as e,o as s,c as i,e as n}from"./app-7c020676.js";const a={},d=n(`<h1 id="服务器添加密钥连接" tabindex="-1"><a class="header-anchor" href="#服务器添加密钥连接" aria-hidden="true">#</a> 服务器添加密钥连接</h1><h2 id="本地生成密钥和公钥" tabindex="-1"><a class="header-anchor" href="#本地生成密钥和公钥" aria-hidden="true">#</a> 本地生成密钥和公钥</h2><ol><li>执行<code>ssh-keygen -t rsa -C &quot;内容可随意输入&quot;</code>然后多次按回车</li></ol><blockquote><p>如需要管理多个密钥 ssh-keygen -t rsa -C &#39;xxxxx@youremail.com&#39; -f ~/.ssh/xxx_id_rsa 生成并配置config文件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># gitee
Host gitee.com
HostName gitee.com
