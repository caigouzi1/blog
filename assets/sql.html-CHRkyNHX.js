import{_ as s,c as a,o as n,a as e}from"./app-DaJ1Kvbf.js";const l={},t=e(`<h1 id="sql使用" tabindex="-1"><a class="header-anchor" href="#sql使用"><span>SQL使用</span></a></h1><h2 id="导出mysql数据库中的表结构" tabindex="-1"><a class="header-anchor" href="#导出mysql数据库中的表结构"><span>导出MySQL数据库中的表结构</span></a></h2><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),i=[t];function p(c,o){return n(),a("div",null,i)}const d=s(l,[["render",p],["__file","sql.html.vue"]]),u=JSON.parse('{"path":"/manual/sql.html","title":"SQL使用","lang":"zh-CN","frontmatter":{"date":"2023-08-15T00:00:00.000Z","category":"开发者手册","tag":["SQL"]},"headers":[{"level":2,"title":"导出MySQL数据库中的表结构","slug":"导出mysql数据库中的表结构","link":"#导出mysql数据库中的表结构","children":[]},{"level":2,"title":"MySQL数据备份和恢复","slug":"mysql数据备份和恢复","link":"#mysql数据备份和恢复","children":[]}],"git":{"createdTime":1716651784000,"updatedTime":1716651784000},"readingTime":{"minutes":0.6,"words":179},"filePathRelative":"manual/sql.md","localizedDate":"2023年8月15日"}');export{d as comp,u as data};
