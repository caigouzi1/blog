...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>`,4),q=n("h2",{id:"图片选择器无法获取图片",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#图片选择器无法获取图片","aria-hidden":"true"},"#"),e(" 图片选择器无法获取图片")],-1),E={href:"https://github.com/react-native-community/react-native-image-picker/issues/1259",target:"_blank",rel:"noopener noreferrer"},A=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>  &lt;application
      ...
