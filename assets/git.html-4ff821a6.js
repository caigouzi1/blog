...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol><h2 id="git使用代理" tabindex="-1"><a class="header-anchor" href="#git使用代理" aria-hidden="true">#</a> git使用代理</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 具体端口号需查看本机配置</span>
